...
#эту суету нужно поправить после того, как пойму почему врезка фокус на себя перенимает
# inset_axes_large = plt.axes([1, 0.6, 0.3, 0.3]) 
# inset_axes_large.set_xlim(0, 5)
# inset_axes_large.set_ylim(0, 5)
# inset_axes_large.grid(True)
